...
# -*- coding: utf-8 -*-
#
#  Generated from FHIR 3.6.0-bd605d07 (http://hl7.org/fhir/StructureDefinition/ResearchElementDefinition) on 2018-12-23.
...
class ResearchElementDefinitionCharacteristic(backboneelement.BackboneElement):
    ...
    def __init__(self, jsondict=None, strict=True):
        ...
        """ extension for fhir primitive  participantEffectiveDateTime"""
        ...
        """ extension for fhir primitive  studyEffectiveDateTime"""
    ...
    def elementProperties(self):
        ...
        js.extend([
            ...
            ("_participantEffectiveDateTime", "_participantEffectiveDateTime",fhirprimitive.FHIRPrimitive, False, None, False),
            ...
            ("_studyEffectiveDateTime", "_studyEffectiveDateTime",fhirprimitive.FHIRPrimitive, False, None, False),
