...
# -*- coding: utf-8 -*-
#
#  Generated from FHIR 3.6.0-bd605d07 (http://hl7.org/fhir/StructureDefinition/FamilyMemberHistory) on 2018-12-23.
...
class FamilyMemberHistory(domainresource.DomainResource):
    ...
    def __init__(self, jsondict=None, strict=True):
        ...
        """ extension for fhir primitive  bornDate"""
        ...
        """ extension for fhir primitive  deceasedDate"""
    ...
    def elementProperties(self):
        ...
        js.extend([
            ...
            ("_bornDate", "_bornDate",fhirprimitive.FHIRPrimitive, False, None, False),
            ...
            ("_deceasedDate", "_deceasedDate",fhirprimitive.FHIRPrimitive, False, None, False),
