...
# -*- coding: utf-8 -*-
#
#  Generated from FHIR 3.6.0-bd605d07 (http://hl7.org/fhir/StructureDefinition/ItemInstance) on 2018-12-23.
...
class ItemInstance(domainresource.DomainResource):
    ...
    def __init__(self, jsondict=None, strict=True):
        ...
        """ extension for fhir primitive  expiryDate"""
        ...
        """ extension for fhir primitive  manufactureDate"""
    ...
    def elementProperties(self):
        ...
        js.extend([
            ...
            ("expiryDate", "expiryDate", FHIRDate, False, None, False),
            ("_expiryDate", "_expiryDate",fhirprimitive.FHIRPrimitive, False, None, False),
            ...
            ("_manufactureDate", "_manufactureDate",fhirprimitive.FHIRPrimitive, False, None, False),
