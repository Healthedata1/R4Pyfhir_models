...
# -*- coding: utf-8 -*-
#
#  Generated from FHIR 3.6.0-bd605d07 (http://hl7.org/fhir/StructureDefinition/Substance) on 2018-12-23.
...
class SubstanceInstance(backboneelement.BackboneElement):
    ...
    def __init__(self, jsondict=None, strict=True):
        ...
        """ extension for fhir primitive  expiry"""
    ...
    def elementProperties(self):
        ...
        js.extend([
            ...
            ("_expiry", "_expiry",fhirprimitive.FHIRPrimitive, False, None, False),
