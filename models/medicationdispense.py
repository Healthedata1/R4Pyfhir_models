...
# -*- coding: utf-8 -*-
#
#  Generated from FHIR 3.6.0-bd605d07 (http://hl7.org/fhir/StructureDefinition/MedicationDispense) on 2018-12-23.
...
class MedicationDispense(domainresource.DomainResource):
    ...
    def __init__(self, jsondict=None, strict=True):
        ...
        """ extension for fhir primitive  whenHandedOver"""
        ...
        """ extension for fhir primitive  whenPrepared"""
    ...
    def elementProperties(self):
        ...
        js.extend([
            ...
            ("_whenHandedOver", "_whenHandedOver",fhirprimitive.FHIRPrimitive, False, None, False),
            ("whenPrepared", "whenPrepared", FHIRDate, False, None, False),
            ("_whenPrepared", "_whenPrepared",fhirprimitive.FHIRPrimitive, False, None, False),
        ])
        return js
