...
# -*- coding: utf-8 -*-
#
#  Generated from FHIR 3.6.0-bd605d07 (http://hl7.org/fhir/StructureDefinition/Communication) on 2018-12-23.
...
class Communication(domainresource.DomainResource):
    ...
    def __init__(self, jsondict=None, strict=True):
        ...
        """ extension for fhir primitive  received"""
        ...
        """ extension for fhir primitive  sent"""
    ...
    def elementProperties(self):
        ...
        js.extend([
            ...
            ("_received", "_received",fhirprimitive.FHIRPrimitive, False, None, False),
            ("recipient", "recipient", fhirreference.FHIRReference, True, None, False),
            ("sender", "sender", fhirreference.FHIRReference, False, None, False),
            ("sent", "sent", FHIRDate, False, None, False),
            ("_sent", "_sent",fhirprimitive.FHIRPrimitive, False, None, False),
