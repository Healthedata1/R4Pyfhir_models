...
# -*- coding: utf-8 -*-
#
#  Generated from FHIR 3.6.0-bd605d07 (http://hl7.org/fhir/StructureDefinition/Observation) on 2018-12-23.
...
class Observation(domainresource.DomainResource):
    ...
    def __init__(self, jsondict=None, strict=True):
        ...
        """ extension for fhir primitive  effectiveDateTime"""
        ...
        """ extension for fhir primitive  effectiveInstant"""
    ...
    def elementProperties(self):
        ...
        js.extend([
            ...
            ("_effectiveDateTime", "_effectiveDateTime",fhirprimitive.FHIRPrimitive, False, None, False),
            ("effectiveInstant", "effectiveInstant", FHIRDate, False, "effective", False),
            ("_effectiveInstant", "_effectiveInstant",fhirprimitive.FHIRPrimitive, False, None, False),
