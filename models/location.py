...
# -*- coding: utf-8 -*-
#
#  Generated from FHIR 3.6.0-bd605d07 (http://hl7.org/fhir/StructureDefinition/Location) on 2018-12-23.
...
class LocationHoursOfOperation(backboneelement.BackboneElement):
    ...
    def __init__(self, jsondict=None, strict=True):
        ...
        """ extension for fhir primitive  closingTime"""
        ...
        """ extension for fhir primitive  openingTime"""
    ...
    def elementProperties(self):
        ...
        js.extend([
            ...
            ("_closingTime", "_closingTime",fhirprimitive.FHIRPrimitive, False, None, False),
            ...
            ("_openingTime", "_openingTime",fhirprimitive.FHIRPrimitive, False, None, False),
        ])
        return js
