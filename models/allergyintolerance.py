...
# -*- coding: utf-8 -*-
#
#  Generated from FHIR 3.6.0-bd605d07 (http://hl7.org/fhir/StructureDefinition/AllergyIntolerance) on 2018-12-23.
...
class AllergyIntolerance(domainresource.DomainResource):
    ...
    def __init__(self, jsondict=None, strict=True):
        ...
        """ extension for fhir primitive  lastOccurrence"""
        ...
        """ extension for fhir primitive  onsetDateTime"""
        ...
        """ extension for fhir primitive  recordedDate"""
    ...
    def elementProperties(self):
        ...
        js.extend([
            ...
            ("_lastOccurrence", "_lastOccurrence",fhirprimitive.FHIRPrimitive, False, None, False),
            ("note", "note", annotation.Annotation, True, None, False),
            ("onsetAge", "onsetAge", age.Age, False, "onset", False),
            ("onsetDateTime", "onsetDateTime", FHIRDate, False, "onset", False),
            ("_onsetDateTime", "_onsetDateTime",fhirprimitive.FHIRPrimitive, False, None, False),
            ...
            ("_recordedDate", "_recordedDate",fhirprimitive.FHIRPrimitive, False, None, False),
...
class AllergyIntoleranceReaction(backboneelement.BackboneElement):
    ...
    def __init__(self, jsondict=None, strict=True):
        ...
        """ extension for fhir primitive  onset"""
    ...
    def elementProperties(self):
        ...
        js.extend([
            ...
            ("_onset", "_onset",fhirprimitive.FHIRPrimitive, False, None, False),
