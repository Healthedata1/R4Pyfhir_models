...
# -*- coding: utf-8 -*-
#
#  Generated from FHIR 3.6.0-bd605d07 (http://hl7.org/fhir/StructureDefinition/MedicinalProduct) on 2018-12-23.
...
class MedicinalProductManufacturingBusinessOperation(backboneelement.BackboneElement):
    ...
    def __init__(self, jsondict=None, strict=True):
        ...
        """ extension for fhir primitive  effectiveDate"""
    ...
    def elementProperties(self):
        ...
        js.extend([
            ...
            ("_effectiveDate", "_effectiveDate",fhirprimitive.FHIRPrimitive, False, None, False),
