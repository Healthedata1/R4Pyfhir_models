...
# -*- coding: utf-8 -*-
#
#  Generated from FHIR 3.6.0-bd605d07 (http://hl7.org/fhir/StructureDefinition/Questionnaire) on 2018-12-23.
...
class QuestionnaireItemEnableWhen(backboneelement.BackboneElement):
    ...
    def __init__(self, jsondict=None, strict=True):
        ...
        """ extension for fhir primitive  answerDate"""
        ...
        """ extension for fhir primitive  answerDateTime"""
        ...
        """ extension for fhir primitive  answerTime"""
    ...
    def elementProperties(self):
        ...
        js.extend([
            ...
            ("_answerDate", "_answerDate",fhirprimitive.FHIRPrimitive, False, None, False),
            ("answerDateTime", "answerDateTime", FHIRDate, False, "answer", True),
            ("_answerDateTime", "_answerDateTime",fhirprimitive.FHIRPrimitive, False, None, False),
            ...
            ("_answerTime", "_answerTime",fhirprimitive.FHIRPrimitive, False, None, False),
